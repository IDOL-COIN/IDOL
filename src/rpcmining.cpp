...
Value getworkex(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(-9, "IDOLCOIN is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "IDOLCOIN is downloading blocks...");
...
Value getwork(const Array& params, bool fHelp)
{
    ...
    // if (vNodes.empty())
    //     throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "IDOLCOIN is not connected!");

    // if (IsInitialBlockDownload())
    //     throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "IDOLCOIN is downloading blocks...");

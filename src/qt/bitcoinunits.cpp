...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("IDOL");
    case dBTC: return QString("BTC");
    // case USD: return QString("USD");
    case mBTC: return QString("mIDOL");
    case uBTC: return QString::fromUtf8("μIDOL");
...
QString BitcoinUnits::description(int unit)
{
    ...
    // case USD: return QString("USD");
    case mBTC: return QString("Milli-IDOL (1 / 1,000)");
    case uBTC: return QString("Micro-IDOL (1 / 1,000,000)");
    default: return QString("???");
    }
}

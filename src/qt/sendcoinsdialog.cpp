    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a IDOLCOIN address (e.g. i4RiEKGTsFsAQvvuqf85YRgnBpCLSf4osu)"));
#endif
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        {
            ui->labelCoinControlChangeLabel->setStyleSheet("QLabel{color:#ff4489;}");
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid IDOLCOIN address"));
        }
        else
        {

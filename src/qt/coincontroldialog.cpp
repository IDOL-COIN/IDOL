...
void CoinControlDialog::updateLabels(WalletModel *model, QDialog* dialog)
{
    ...
    // turn labels "red"
    l5->setStyleSheet((nBytes >= 10000) ? "color:#ff4489;" : "");               // Bytes >= 10000
    l6->setStyleSheet((dPriority <= 576000) ? "color:#ff4489;" : "");         // Priority < "medium"
    l7->setStyleSheet((fLowOutput) ? "color:#ff4489;" : "");                    // Low Output = "yes"
    l8->setStyleSheet((nChange > 0 && nChange < CENT) ? "color:#ff4489;" : ""); // Change < 0.01BTC

...
extern json_spirit::Value move_scmd(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value sendfrom(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value sendfrom_s(const json_spirit::Array& params, bool fHelp);
